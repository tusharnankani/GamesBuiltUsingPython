...
Else, farther from the number than the previous guess, "COLDER!" will be printed.""")
print("""5. If your guess is within 2 of the number, "VERY WARM!" will be printed.""")
input() 
...
while(user_guess!=comp_num):
	...
	while(1>user_guess or user_guess>100):
		...
		if 1>user_guess or user_guess>100 or user_guess=None:
			print("OUT OF BOUNDS")

	temp=abs(user_guess-comp_num)

	#if the guess is within 2;
	if temp<=2:
		print("VERY WARM")
